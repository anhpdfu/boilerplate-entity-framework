...
using Boilerplate.Utility.Helpers;
using System;
...
namespace Boilerplate.EFCore.Data
{
    public class DataRepository<T> : IDataRepository<T> where T : BaseEntity
    {
        ...
        public DataRepository(IBoilerplateDbContext dbContext)
        {
        ...
        ///     Entities
        /// </summary>
        protected virtual IDbSet<T> Entities => _entityDbSet ?? (_entityDbSet = _dbContext.Set<T>());
